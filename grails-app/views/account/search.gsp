...
<g:each in="${foundcompanies}" var="company">
        <article class="search-result row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-7">
                ...
                <g:if test="${!ada.Friend?.findByUser1AndUser2(company,currentUser) && !ada.Friend?.findByUser1AndUser2(currentUser,company)}">
                <span class="plus"><a href="${createLink(action: 'addFriend',id:company?.id,params: [q:params?.q])}" title=""><i class="glyphicon glyphicon-plus"></i></a></span>
                </g:if>
                %{--<g:else>--}%
